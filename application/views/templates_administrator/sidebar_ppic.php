  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo base_url('administrator/dashboard_ppic') ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url('administrator/dt_jadwal/dt_jadwal_tampil_ppic') ?>">
          <i class="fas fa-fw fa-folder"></i>
          <span>Penjadwalan</span>
        </a>
      </li>

      <!-- Nav Item - Cek Hasil Produksi -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('administrator/dt_hasil') ?>">
