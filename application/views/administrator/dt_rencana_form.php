<div class="container-fluid">
	...
	<form method="post" action="<?php echo base_url('administrator/dt_pesanan/tambah_pesanan_aksi') ?>">
		<div class="form-group">
			...
			<input type="text" name="tgl_pesan" placeholder="Masukkan Tanggal Pesanan" class="form-control">
		...
		<div class="form-group">
			...
			<input type="text" name="no_po" placeholder="Masukkan Nomor PO" class="form-control">
